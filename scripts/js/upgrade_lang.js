...
var en_us = {}
console.log("Loading en_us.json")
var string = fs.readFileSync(path.join(langfolderpath, "en_us.json"));
console.log(string.toString())
en_us = JSON.parse(string.toString().trimLeft());
console.log(" ")
for (var i = 0; i < langfiles.length; i++) {
    ...
    var langfile = JSON.parse(fs.readFileSync(langfilepath).toString().trimLeft())
