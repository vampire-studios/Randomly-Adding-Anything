...
public class RAADimensionMaterialListWidget extends DynamicElementListWidget<RAADimensionMaterialListWidget.Entry> {
    public RAADimensionMaterialListWidget(MinecraftClient client, int width, int height, int top, int bottom, Identifier backgroundLocation) {
