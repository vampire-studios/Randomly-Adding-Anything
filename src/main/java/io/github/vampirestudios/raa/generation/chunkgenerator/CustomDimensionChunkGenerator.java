...
public class CustomDimensionChunkGenerator extends SurfaceChunkGenerator<OverworldChunkGeneratorConfig> {
    ...
    public CustomDimensionChunkGenerator(IWorld iWorld_1, BiomeSource biomeSource_1, OverworldChunkGeneratorConfig overworldChunkGeneratorConfig_1) {
    ...
    public void populateEntities(ChunkRegion chunkRegion_1) {
        ...
        Biome biome_1 = chunkRegion_1.getBiomeAccess().getBiome((new ChunkPos(int_1, int_2)).getCenterBlockPos());
    ...
    protected double[] computeNoiseRange(int int_1, int int_2) {
        ...
        for(int int_5 = -2; int_5 <= 2; ++int_5) {
            for(int int_6 = -2; int_6 <= 2; ++int_6) {
                ...
                float float_7 = BIOME_WEIGHT_TABLE[int_5 + 2 + (int_6 + 2) * 5] / (float_5 + 2.0F);
