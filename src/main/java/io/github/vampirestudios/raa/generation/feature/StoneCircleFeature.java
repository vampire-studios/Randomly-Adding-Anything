...
public class StoneCircleFeature extends Feature<DefaultFeatureConfig> {
    ...
    public StoneCircleFeature(DimensionData dimensionData) {
        ...
        STONE = Registry.BLOCK.get(Utils.addSuffixToPath(dimensionData.getId(),"_stone")).getDefaultState();
        COBBLESTONE = Registry.BLOCK.get(Utils.addSuffixToPath(dimensionData.getId(),"_cobblestone")).getDefaultState();
    }
