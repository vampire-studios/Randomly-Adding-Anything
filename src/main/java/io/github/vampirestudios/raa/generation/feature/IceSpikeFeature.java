...
public class IceSpikeFeature extends Feature<DefaultFeatureConfig> {
   ...
   public boolean generate(ServerWorldAccess iWorld, StructureAccessor StructureAccessor, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, DefaultFeatureConfig defaultFeatureConfig) {
