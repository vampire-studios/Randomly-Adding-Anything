...
//        this.addStructureFeature(Feature.STRONGHOLD.configure(FeatureConfig.DEFAULT));
        ...
        if (Utils.checkBitFlag(dimensionData.getFlags(), Utils.ABANDONED) || Utils.checkBitFlag(dimensionData.getFlags(), Utils.DEAD)) outpostChance = Rands.randFloatRange(0.002F, 0.006F);
