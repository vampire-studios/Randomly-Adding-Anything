...
//        this.sampleNoiseColumn(buffer, x, z, 1024, 1024, 16, 4, 8, -32); // regular
//        this.sampleNoiseColumn(buffer, x, z, 1024, 128, 16, 12, 3, 48); //le epic caves
        this.sampleNoiseColumn(buffer, x, z, 1024, 512, 16, 4, 8, (int) (field_16574.sample(x / 20f, 0, z / 20f)*1000)); //a disaster
    }
