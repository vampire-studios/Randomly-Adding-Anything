...
//This should never generate in prod environments! it's only for testing random code.
...
public class TestChunkGenerator extends SurfaceChunkGenerator<OverworldChunkGeneratorConfig> {
    ...
    public TestChunkGenerator(IWorld world, BiomeSource biomeSource, OverworldChunkGeneratorConfig config) {
...
//        e += (Math.sin(e) * ((y + 8) / 4f));
    ...
    public List<Biome.SpawnEntry> getEntitySpawnList(EntityCategory category, StructureAccessor StructureAccessor, BlockPos pos) {
