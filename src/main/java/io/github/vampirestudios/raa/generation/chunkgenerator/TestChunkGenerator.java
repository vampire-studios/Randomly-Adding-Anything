...
public class TestChunkGenerator extends SurfaceChunkGenerator<OverworldChunkGeneratorConfig> {
    ...
    public TestChunkGenerator(long seed, BiomeSource biomeSource, OverworldChunkGeneratorConfig config) {
...
//        this.amplified = world.getLevelProperties().getGeneratorType() == LevelGeneratorType.AMPLIFIED;
    ...
    public ChunkGenerator create(long seed) {
        return new TestChunkGenerator(seed, this.biomeSource.create(seed), this.chunkGeneratorConfig);
    }
