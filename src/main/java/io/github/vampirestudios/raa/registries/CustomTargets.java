...
public class CustomTargets {
    ...
    public static void init() {
        ...
        if (FabricLoader.getInstance().isModLoaded("thehallow")) {
            Block grassBlock = Registry.BLOCK.get(new Identifier("thehallow", "deceased_grass_block"));
            RegistryUtils.registerOreTarget(new Identifier("thehallow", "deceased_grass_block"), new BlockPredicate(grassBlock), grassBlock);
            Block dirtBlock = Registry.BLOCK.get(new Identifier("thehallow", "deceased_dirt"));
            RegistryUtils.registerOreTarget(new Identifier("thehallow", "deceased_dirt"), new BlockPredicate(dirtBlock), dirtBlock);
            Block stoneBlock = Registry.BLOCK.get(new Identifier("thehallow", "tainted_stone"));
            RegistryUtils.registerOreTarget(new Identifier("thehallow", "tainted_stone"), new BlockPredicate(stoneBlock), stoneBlock);
            Block taintedSand = Registry.BLOCK.get(new Identifier("thehallow", "tainted_sand"));
            RegistryUtils.registerOreTarget(new Identifier("thehallow", "tainted_sand"), new BlockPredicate(taintedSand), taintedSand);
            Block taintedSandstone = Registry.BLOCK.get(new Identifier("thehallow", "tainted_sandstone"));
            RegistryUtils.registerOreTarget(new Identifier("thehallow", "tainted_sandstone"), new BlockPredicate(taintedSandstone), taintedSandstone);
            Block taintedGravel = Registry.BLOCK.get(new Identifier("thehallow", "tainted_gravel"));
            RegistryUtils.registerOreTarget(new Identifier("thehallow", "tainted_gravel"), new BlockPredicate(taintedGravel), taintedGravel);
        }
    }
